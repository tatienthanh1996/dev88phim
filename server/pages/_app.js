...
function MyApp({ Component , pageProps  }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_5__.useEffect)(()=>{
        ...
        _utils_supabase__WEBPACK_IMPORTED_MODULE_8__/* .supabase.auth.onAuthStateChange */ .O.auth.onAuthStateChange(()=>setUser(_utils_supabase__WEBPACK_IMPORTED_MODULE_8__/* .supabase.auth.user */ .O.auth.user()));
...
var __webpack_exports__ = __webpack_require__.X(0, [699,604], () => (__webpack_exec__(2957)));
